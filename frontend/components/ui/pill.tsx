...
const Pill: React.FC = () => {
    return (
        <div 
            className="absolute top-[16px] right-[80px] flex space-x-[24px] items-center justify-center rounded-[8px] w-[332px] h-[80px] shadow-[0_4px_24px_rgba(0,0,0,0.25)] z-[97] bg-white" >
